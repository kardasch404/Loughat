...
@section('content')
                    ...
                    <div class="col-lg-12">
                        <div class="brand-area">
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/1.png') }}" alt="Brand"
                                    class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/2.png') }}" alt="Brand"
                                    class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/3.png') }}" alt="Brand"
                                    class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/4.png') }}" alt="Brand"
                                    class="img-fluid" />
                            </div>
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/2.png') }}" alt="Brand"
                            ...
                            <div class="brand-area-image">
                                <img src="{{ asset('assets/user/dist/images/versity/5.png') }}" alt="Brand"
                                    class="img-fluid" />
                            </div>
                        </div>
                    </div>
    ...
    <section class="section best-instructor-featured overflow-hidden main-instructor-featured">
        ...
        <div class="main-instructor-featured-shape">
            <img src="{{ asset('assets/user/dist/images/shape/dots/dots-img-14.png') }}" alt="shape" class="img-fluid shape01" />
            <img src="{{ asset('assets/user/dist/images/shape/triangel2.png') }}" alt="shape" class="img-fluid shape02" />
        </div>
    </section>
