                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-checkout" role="tabpanel"
                                ...
                                <form action="{{ route('payment.process') }}" method="POST">
                                    ...
                                    <input type="hidden" name="amount" value="{{ $commande->montant }}">

                                    <div class="mb-3">
                                        <label for="card-name-one">Name on Card</label>
                                        <input type="text" class="form-control" placeholder="Type here"
                                            id="card-name-one" name="card_name" required />
                                    </div>
                                    <div class="mb-3">
                                        <label for="card-number-one">Card Number</label>
                                        <input type="text" class="form-control" placeholder="Type here"
                                            id="card-number-one" name="card_number" required />
                                    </div>
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-md-6 mb-3 mb-lg-0">
                                                ...
                                                <input type="text" class="form-control" placeholder="Type here"
                                                    id="expiration-date-one" name="expiration_date" required />
                                            </div>
                                            <div class="col-md-6">
                                                <label for="cvc-one">CVC</label>
                                                <input type="text" class="form-control" id="cvc-one"
                                                    placeholder="Type here" name="cvc" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <div class="form-check d-flex align-items-center ps-0">
                                            <input type="checkbox" id="flexCheckIndeterminate-one" name="save_info" />
                                    ...
                                    <button type="submit" name="submit"
                                        class="button button-lg button--primary w-100">Confirm
                                        Payment</button>
                                </form>
                            </div>
                                ...
                                <form action="{{ route('payment.process') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" placeholder="Your PayPal email"
                                            id="paypal-email" name="paypal_email" required />
                                    </div>
                                    ...
                                    <button type="submit" name="submit"
                                        class="button button-lg button--primary w-100">Pay with
                                        PayPal</button>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="productContent__wrapper">
                                    <div class="productContent">
                                        <div class="productContent-item__img productContent-item">
                                            <img src="{{ $commande->cours->photo }}" alt="checkout" />
                                        </div>
                                        <div class="productContent-item__info productContent-item">
                                            <h6 class="font-para--lg">
                                                <a href="">{{ $commande->cours->title }}</a>
                                            </h6>
                                            <p>by {{ $commande->cours->teacher->lastname }}
                                                {{ $commande->cours->teacher->firstname }}</p>
                                            <div class="price">
                                                <h6 class="font-para--md">${{ $commande->cours->price }}</h6>
                                                <p><del>$95</del></p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="cart__checkout-process">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <p class="total-price font-title--card">${{ $commande->cours->price }}</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
