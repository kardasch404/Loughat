...
@section('content')
        ...
        <div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb pb-0 mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ url('/contact') }}" class="fs-6 text-secondary">Contact</a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="hero__img-content">
                        <div class="hero__img-content--main">
                            <img src="{{ asset('assets/user/dist/images/contact/image.jpg') }}" alt="image" />
                        </div>
                        <img src="{{ asset('assets/user/dist/images/shape/dots/dots-img-02.png') }}" alt="shape"
                            class="hero__img-content--shape-01" />
                        <img src="{{ asset('assets/user/dist/images/shape/rec05.png') }}" alt="shape" class="hero__img-content--shape-02" />
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="section getin-touch overflow-hidden" style="background-image: url({{ asset('assets/user/dist/images/contact/bg.png') }});">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 form-area">
                    ...
                    <div class="form-area-shape">
                        <img src="{{ asset('assets/user/dist/images/shape/circle3.png') }}" alt="Shape" class="img-fluid shape-01" />
                        <img src="{{ asset('assets/user/dist/images/shape/circle5.png') }}" alt="Shape" class="img-fluid shape-02" />
                    </div>
                </div>
            </div>
        </div>
