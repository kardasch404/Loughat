         ...
         <div class="col-lg-8">
             <div class="course-description-start">
                 <div class="video-area">
                     <video controls id="my-video" class="video-js w-100" poster="dist/images/courses/vthumb.jpg"
                         data-setup="{}">
                             ...
                             <div class="course-notes-area">
                                 <div class="course-notes">
                                     ...
                                     <div class="course-notes-item">
                                         ...
                                         <p>
                                             ...
                                             problem, what they're trying to achieve with it who is the target audience,
                                             who is the competition, and understand
                                             what are you trying to do here and how will success will look like of the
                                 ...
                                 <div class="course-notes">
                                     ...
                                     <div class="course-notes-item">
                                         <div class="dot"></div>
                                         <p>
                                             The way to get the idea is by removing your barriers about I only need to
                                 ...
                                 <div class="course-notes">
                                     <h6>Steps 3: take the kind of rough idea that you have been trying to validate it
                                     </h6>
                                     <div class="course-notes-item">
                                         <div class="dot"></div>
                                         <p>
                                             By validating I mean you present it. so you do a present it's a client work
                                             you do a presentation you show them the work. and you're saying here it is
                                 ...
                                 <div class="course-notes mb-0">
                                     ...
                                     <div class="course-notes-item">
                                         ...
                                         <p>
                                             ...
                                             your design and improve it and make it better then it's ready after you've
                                 ...
                                 <div class="col-lg-12">
                                     <div class="course-instructor mw-100">
                                         ...
                                         <p class="course-instructor-description">
                                             ...
                                             That work includes commercial industry
                 ...
                 <div class="videolist-area-bar__wrapper">
                    ...
                    @foreach ($course as $cours)
                         ...
                         <div class="wizard-heading">
                             <h6 class="">{{$cours->section->title}}</h6>
                         </div>
                             ...
                             <div class="main-wizard__wrapper active">
                                 <a class="main-wizard-start">
                                     ...
                                     <div class="main-wizard-title">
                                         <p>{{$cours->section->lesson->order}}. {{$cours->section->lesson->title}}</p>
                                     </div>
                                 </a>
                                 <div class="main-wizard-end d-flex align-items-center">
                                     <span>{{$cours->section->lesson->duration}}</span>
