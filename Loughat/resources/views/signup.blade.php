...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center justify-content-md-center">
                <div class="col-lg-5 order-2 order-lg-0">
                    <div class="signup-area-textwrapper scrollable-form">
                        <h2 class="font-title--md mb-0">Sign Up</h2>
                        <p class="mt-2 mb-lg-4 mb-3">Already have account? <a href="/signin" class="text-black-50">Sign In</a>
                        </p>
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-element">
                                <button type="submit" name="submit" class="button button-lg button--primary w-100">Sign
                                    UP</button>
                            </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap mt-3 signinButtons">
                                ...
                                <a href="#"
                                    ...
                                    <svg class="me-2" width="22" height="19" viewBox="0 0 22 19"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <div class="col-lg-7 order-1 order-lg-0">
                    <div class="signup-area-image fixed-image">
                        <img src="{{ asset('assets/user/dist/images/signup/Illustration.png') }}" alt="Illustration Image"
                            class="img-fluid" />
                    </div>
                </div>
            </div>
    ...
    <div class="dot-images">
        <img src="{{ asset('assets/user/dist/images/shape/dots/dots-img-05.png') }}" alt="shape"
            class="img-fluid first-dotimage" />
        <img src="{{ asset('assets/user/dist/images/shape/dots/dots-img-07.png') }}" alt="shape"
