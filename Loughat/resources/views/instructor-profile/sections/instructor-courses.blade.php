              ...
              <div class="col-lg-4">
                  <div class="instructor-courses-instructor">
                      <div class="instructor-image mx-auto text-center">
                          <img src="{{ $teacher->photo }}" alt="Instructor" />
                      </div>
                      <div class="instructor-info text-center">
                          <h5 class="font-title--sm">{{ $teacher->firstname }} {{ $teacher->lastname }}</h5>
                          <p class="text-secondary mb-3">{{ $teacher->specialization }}</p>
                      ...
                      <div class="about-instructor">
                          ...
                          <p>
                              ...
                              sides of that equation, and getting to deliver useful training is my meaningful way to be
