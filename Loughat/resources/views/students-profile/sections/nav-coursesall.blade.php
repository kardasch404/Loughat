                    ...
                    <div class="contentCard contentCard--watch-course">
                        ...
                        <div class="contentCard-bottom">
                            ...
                            <div class="contentCard-info d-flex align-items-center justify-content-between">
                                <a href="{{ $cours->teacher->id }}" class="contentCard-user d-flex align-items-center">
                                    <img src="{{ asset($cours->teacher->photo) }}" alt="teacher-image"
                            ...
                            <a class="button button-md button--primary-outline w-100 my-3" href="{{ route('watch.watchCours', $cours->id) }}">Watch
                                Course</a>
